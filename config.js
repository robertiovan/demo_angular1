System.config({
  ...
  map: {
    "@types/angular": "npm:@types/angular@1.6.2",
    "@types/angular-material": "npm:@types/angular-material@1.1.44",
    "@types/angular-ui-router": "npm:@types/angular-ui-router@1.1.36",
    ...
    "app": "src",
    "d3": "npm:d3@3.5.17",
    "jasmine": "npm:jasmine@2.5.2",
    "karma-ng-html2js-preprocessor": "npm:karma-ng-html2js-preprocessor@1.0.0",
    ...
    "npm:@types/angular-material@1.1.44": {
      "@types/angular": "npm:@types/angular@1.6.2"
    },
    "npm:@types/angular-ui-router@1.1.36": {
      "@types/angular": "npm:@types/angular@1.6.2"
    },
    "npm:@types/angular@1.6.2": {
    ...
    "npm:karma-ng-html2js-preprocessor@1.0.0": {
    ...
    "npm:karma@1.3.0": {
      ...
      "tmp": "npm:tmp@0.0.28",
      "url": "github:jspm/nodelibs-url@0.1.0",
      "useragent": "npm:useragent@2.1.10",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
    "npm:kind-of@3.1.0": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
